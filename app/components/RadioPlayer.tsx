...
//     const showThumbnail = Boolean(videoId); // 👈 ab isPlaying pe depend nahi karta — song load hote hi poster dikhega
//
//     return (
//         <div
//             className="fixed bottom-8 sm:bottom- 15 left-1/2 -translate-x-1/2 w-[96%] sm:w-[92%] max-w-2xl rounded-2xl sm:rounded-full px-3 sm:px-4 py-2.5 sm:py-3 flex items-center gap-2 sm:gap-4"
//             style={{
...
//                 <p
//                     className="text-[14px] sm:text-[16px] truncate leading-tight"
//                     style={{ color: "#FFFFFF", fontFamily: "'Work Sans', sans-serif", fontWeight: 700 }}
//                 >
//                     {title}
//                 </p>
//                 <p
//                     className="text-[12px] sm:text-[13px] truncate leading-tight mt-[2px]"
...
//
//             {/* Center controls */}
//             <div className="flex items-center gap-3 sm:gap-4 mx-auto shrink-0">
//                 <button
//                     onClick={playPrev}
//                     aria-label="Previous"
//                     disabled={!isReady}
...
//                     disabled={!isReady}
//                     className="w-12 h-12 sm:w-14 sm:h-14 rounded-full flex items-center justify-center cursor-pointer disabled:cursor-not-allowed disabled:opacity-50"
//                     style={{
//                         background: "#FFF6E8",
//                         color: "#241209",
...
//                         </svg>
//                     ) : (
//                         <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" style={{ marginLeft: "2px" }} className="sm:w-[18px] sm:h-[18px]">
...
export default function RadioPlayer({ playlistId, categoryTitle }: RadioPlayerProps) {
    ...
    return (
        <div
            className="fixed bottom-8 sm:bottom-16 left-1/2 -translate-x-1/2 w-[96%] sm:w-[92%] max-w-2xl rounded-2xl sm:rounded-full px-3 sm:px-4 py-2.5 sm:py-3 flex items-center gap-2 sm:gap-4"
            style={{
                background: "linear-gradient(180deg, rgba(38, 22, 16, 0.94), rgba(20, 11, 8, 0.96))",
                backdropFilter: "blur(16px)",
                border: "1px solid rgba(214, 140, 47, 0.22)",
            ...
            <div className="flex items-center gap-3 sm:gap-4 mx-auto shrink-0">
                ...
                >
                    {isPlaying ? (
                        ...
                        <svg width="27" height="27" viewBox="0 0 24 24" fill="currentColor" style={{ marginLeft: "2px" }} className="sm:w-[27px] sm:h-[27px]">
                            <path d="M8 5v14l11-7z" />
                        </svg>
                    )}
                </button>
